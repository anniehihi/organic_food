<?php include('./partials/header.php'); ?>
            ...
            <div class="page-heading">
                ...
                <div class="ibox-head">
                    <a href="<?php echo SITEURL; ?>admin/add-product.php"><button class="btn btn-default btn-xs" data-toggle="tooltip" data-original-title="Thêm mới"><i class="fa fa-plus font-14"></i></button></a>
                </div>
                <form action="search.php" method="POST">
                    <div class="row">
                        <div class="col-md-4">
